<?php
		...
		$cliesnIP;
		$chack_in2	= '2017-11-19';
		$chack_out2	= '2017-11-20';
		$guest		= '2';
		$children 	= '1';
		$marker = 131134;
		...
		echo  $mdd5 = "$token:$marker:$guest:$chack_in2:$chack_out2:$children:USD:114.31.20.47:358105:en:0";

		//echo '</br>';echo '</br>';
		$signature = md5($mdd5);
		$searchId =	'http://engine.hotellook.com/api/v2/search/start.json?hotelId=358105&checkIn='.$chack_in2.'&checkOut='.$chack_out2.'&adultsCount='.$guest.'&customerIP=114.31.20.47&childrenCount='.$children.'&lang=en&currency=USD&waitForResult=0&marker='.$marker.'&signature='.$signature.'';
